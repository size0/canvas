...
const VIDEO_MODELS = [
    // gpt2api.com 视频模型
    { id: 'xai/grok-imagine-video', name: 'Grok Imagine Video', provider: 'gpt2api', recommended: true, durations: [6, 10, 20, 30], resolutions: ['720p', '1080p'] },
    { id: 'veo3.1-lite', name: 'VEO 3.1 Lite', provider: 'gpt2api', durations: [6, 10, 20, 30], resolutions: ['720p', '1080p'] },
    { id: 'veo3.1', name: 'VEO 3.1', provider: 'gpt2api', durations: [6, 10, 20, 30], resolutions: ['720p', '1080p'] },
    { id: 'veo3.1-flash', name: 'VEO 3.1 Flash', provider: 'gpt2api', durations: [6, 10, 20, 30], resolutions: ['720p', '1080p'] },
    { id: 'sora', name: 'Sora 2', provider: 'gpt2api', durations: [6, 10, 20, 30], resolutions: ['720p', '1080p'] },
    {
        id: 'veo-3.1',
        name: 'Veo 3.1',
        provider: 'google',
